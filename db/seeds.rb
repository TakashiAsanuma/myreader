...
Site.first_or_create([
  ...
  {:id => 88, :name => "Zillow Engineering", :channel_id => 301, :url => 'https://engineering.zillow.com/feed/'},
  {:id => 89, :name => "Chef Blog", :channel_id => 301, :url => 'https://blog.chef.io/feed/'},
  {:id => 90, :name => "Docker Blog", :channel_id => 301, :url => 'https://blog.docker.com/category/engineering/feed/'},
  {:id => 91, :name => "Indeed Engineering Blog", :channel_id => 301, :url => 'http://engineering.indeedblog.com/blog/feed/'},
  {:id => 92, :name => "Engineering @ Microsoft", :channel_id => 301, :url => 'https://engineering.microsoft.com/feed/'},
  {:id => 93, :name => "Slack Engineering Blog", :channel_id => 301, :url => 'https://slack.engineering/feed'},
  {:id => 94, :name => "Google Developers Blog", :channel_id => 301, :url => 'http://feeds.feedburner.com/GDBcode'},
  {:id => 95, :name => "AWS Blog", :channel_id => 301, :url => 'http://feeds.feedburner.com/AmazonWebServicesBlog'},
])
