...
Channel.first_or_create([
  ...
  {:id => 1302, :name => 'テックブログ（個人）', :region => 1, :category_id => 300, :default_flag => true, :enabled => true},
  {:id => 1303, :name => 'デザインブログ（企業）', :region => 1, :category_id => 300, :default_flag => true, :enabled => true},
  {:id => 1304, :name => 'デザインブログ（個人）', :region => 1, :category_id => 300, :default_flag => true, :enabled => true},
