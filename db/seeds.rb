...
Channel.first_or_create([
  ...
  {:id => 1001, :name => 'テック', :region => 1, :category_id => 1, :default_flag => true, :enabled => true},
  {:id => 1002, :name => 'ガジェット', :region => 1, :category_id => 1, :default_flag => true, :enabled => true},
  {:id => 1003, :name => 'デベロップ', :region => 1, :category_id => 1, :default_flag => true, :enabled => true},
  {:id => 1004, :name => 'セキュリティ', :region => 1, :category_id => 1, :default_flag => true, :enabled => true},
  {:id => 1201, :name => 'デザイン', :region => 1, :category_id => 200, :default_flag => true, :enabled => true},
  {:id => 1202, :name => 'フロントエンド', :region => 1, :category_id => 200, :default_flag => true, :enabled => true},
  {:id => 1301, :name => 'Company Tech Blog', :region => 1, :category_id => 300, :default_flag => true, :enabled => true},
  {:id => 1302, :name => 'Personal Tech Blog', :region => 1, :category_id => 300, :default_flag => true, :enabled => true},
  {:id => 1303, :name => 'Company Design Blog', :region => 1, :category_id => 300, :default_flag => true, :enabled => true},
  {:id => 1304, :name => 'Personal Design Blog', :region => 1, :category_id => 300, :default_flag => true, :enabled => true},
  {:id => 1401, :name => 'Github Release', :region => 1, :category_id => 400, :default_flag => false, :enabled => true},
  {:id => 1402, :name => 'Github Trend', :region => 1, :category_id => 400, :default_flag => false, :enabled => true},
  {:id => 1999, :name => '一般', :region => 1, :category_id => 999, :default_flag => true, :enabled => true},
])
