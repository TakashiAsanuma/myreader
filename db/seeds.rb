...
Channel.first_or_create([
  ...
  {:id => 1301, :name => 'テックブログ（企業）', :region => 1, :category_id => 300, :default_flag => true, :enabled => true},
  {:id => 1302, :name => 'Personal Tech Blog', :region => 1, :category_id => 300, :default_flag => true, :enabled => true},
  {:id => 1303, :name => 'デザインブログ（企業）', :region => 1, :category_id => 300, :default_flag => true, :enabled => true},
